// Central constants file for the EXPchain Network Automation Tool
module.exports = {
  // Network information
  NETWORK: {
    ...
    EXPLORER_URL: "https://blockscout-testnet.expchain.ai",
    CURRENCY_SYMBOL: "tZKJ"
  },
  
  // Faucet information
  FAUCET: {
    DISCORD_AUTH_URL: "https://discord.com/api/v10/oauth2/authorize?client_id=1324639318278406267&redirect_uri=https%3A%2F%2Ffaucet-api.expchain.ai%2Fapi%2Fv1%2Fdiscord%2Fcallback&response_type=code&scope=identify+email",
    CALLBACK_URL: "https://faucet-api.expchain.ai/api/v1/discord/callback",
    FAUCET_API_URL: "https://faucet-api.expchain.ai/api/faucet",
    CHAIN_ID: 18880
  },
  ...
  // ERC20 token generation (template codes remain the same)
  ERC20: {
    TOKEN_NAME_PREFIXES: [
  ...
  // NFT collection template remains the same
  NFT: {
    NAME_PREFIXES: [
